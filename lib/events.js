 ...
 */
const runContentAnalysis = (content, context = '') => {
  ...
  debug('analysis:classifications', availableClassifiers)
  debug('analysis:sentiment', sentimentResult)
...
const runMiddleware = (T, content) => {
  ...
  const analysis = runContentAnalysis(content, context)
  content.analysis = analysis

  const availableClassifiers = analysis.nlp.classifications
  const highestClassifier = analysis.nlp.classified
